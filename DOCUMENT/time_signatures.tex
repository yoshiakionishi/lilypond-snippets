...
\textcolor{blue}{\textbf{New to \Verb|2.26.0|: }LilyPond's \Verb|\textbackslash time| command accepts fractional time signatures, making the relevant codes discussed in the first nine entries of this chapter obsolete.\footnote{\url{https://lilypond.org/doc/v2.26/Documentation/changes/rhythm-improvements} and \url{https://lilypond.org/doc/v2.26/Documentation/notation/displaying-rhythms\#time-signature}} However, for the time being I will continue to keep the codes current, for they may offer good case studies of how custom Scheme codes interact with overriding stencil functions.}
