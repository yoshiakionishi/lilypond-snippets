...
\section {Slashed Beam}
\hfill
\lilypondfile{/slashBeam.ly}
\hfill

\subsection{Description}
This function adds a slash to an ordinary beam in order to simulate a group of grace notes. See \hyperref[sec:repeat_notepatterns_afap]{\textbf{Repeat Note Patterns As Fast As possible}} in \chapref*{ch:combinations} for an example of using this function. \par
