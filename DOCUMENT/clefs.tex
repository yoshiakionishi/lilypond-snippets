...
\label{sec:pianoStringsClef}
\section {Piano Strings Clef}
\hfill
\lilypondfile[staffsize=24,hpadding=4,voffset=4pt]{/pianoStringsClef.ly}
\hfill
...
#(ly:stencil-add
  ...
  (ly:stencil-translate clefSpace (cons 2 0))
  (ly:stencil-translate clefSpace (cons 0 -5)
                        ;adjust the numbers for second 'space' to
...
\item If you do not wish the ledger lines to appear within the staff line, consider using: \par
 \verb|\override Staff.NoteHead.no-ledgers = ##t|.
\end{enumerate}
