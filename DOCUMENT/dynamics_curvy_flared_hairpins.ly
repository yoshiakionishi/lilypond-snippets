...
#(define-music-function (num dyn) ((number? 0) ly:event? )
  (let* ((hOffset num))
   #{
    \tweak Hairpin.stencil #flared-hairpin-curvy
...

{
 ...
 c' \fff \flaredCrescCurvy #0.25 \< c' c' c' \o \flaredDecrescCurvy #0 \>
 c' c'\o\flaredCrescCurvy #-0.6  \< c' c' \break
 \repeat unfold 3  {c' c' c' c'} \break
 c'\ff \flaredDecrescCurvy \> c' c' c'
 c' \p \flaredCrescCurvy \< c' c' \flaredDecrescCurvy \> c'
