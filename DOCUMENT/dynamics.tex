...
\textcolor{red}{\textbf{NB: }Significantly updated on December 23, 2025}
...
\textcolor{red}{Update: December 23, 2025 } \verb|\nCrescTweak| and \verb|\nDecrescTweak| accepts a number as an optional argument. This functionality has been added to allow the adjustment of the hairpin at the arrival point. Think of this as an \verb|X-offset| for the arrival point. See \textbf{Code}. 
